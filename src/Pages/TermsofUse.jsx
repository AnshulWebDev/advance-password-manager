...
const TermsofUse = () => {
  return (
    <div className="bg-[#2B2B2B] md:px-24 px-8 h-full text-neutral-500">
      <Helmet>
        <title>CipherGuard - Terms Of Use</title>
        <meta name="description" content="Cipher Guard Privacy Policy page." />
      </Helmet>
      <Navbar />
      <div className=" flex flex-col gap-3 mt-5">
        <h1 className=" text-3xl font-medium text-neutral-300 ">Terms of Use</h1>

        <p>Version 1.0</p>

        <p>
          The cipherguard.cleverpentester.com website located at
          https://cipherguard.cleverpentester.com is a copyrighted work
          belonging to Cipher Guard. Certain features of the Site may be subject
        ...
        <h2 className=" text-2xl font-medium text-neutral-300 ">Access to the Site</h2>
        ...
        <h2 className=" text-2xl font-medium text-neutral-300 ">User Content</h2>
        ...
        <h2 className=" text-2xl font-medium text-neutral-300 ">Third-Party Links & Ads; Other Users</h2>
        ...
        <p>
          ...
          cipherguard.cleverpentester.com uses ‘cookies'. These cookies are used
        ...
        <h2 className=" text-2xl font-medium text-neutral-300 ">Disclaimers</h2>
        ...
        <h2 className=" text-2xl font-medium text-neutral-300 ">Limitation on Liability</h2>
        ...
        <h2 className=" text-2xl font-medium text-neutral-300 ">Copyright Policy.</h2>
        ...
        <h2 className=" text-2xl font-medium text-neutral-300 ">General</h2>
        ...
        <p>
          ...
          the Company should be sent to: support@cleverpentester.com. After the
        ...
        <p>
          ...
          to the personal jurisdiction of the courts located within in County,
        ...
        <h2 className=" text-2xl font-medium text-neutral-300 ">Contact Information</h2>
        <p>Email: support@cleverpentester.com</p>
      </div>
      <Footer />
    </div>
  );
