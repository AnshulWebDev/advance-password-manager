  ...
  return (
    <div className="bg-[#2B2B2B] md:px-24 px-8 h-full text-neutral-500">
      ...
      <div className=" flex flex-col gap-3 mt-5">
        ...
        <h3 className=" text-xl font-medium text-neutral-300 ">Definitions</h3>
        ...
        <ul className=" flex flex-col gap-3 ml-12 list-disc">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to CipherGuard.
            </p>
          </li>
          <li>
            <p>
        ...
        <h4 className=" text-lg font-medium text-neutral-300 ">Usage Data</h4>
        ...
        <h4 className=" text-xl font-medium text-neutral-300 ">
          Law enforcement
        </h4>
        <p>
        ...
        <h2 className=" text-2xl font-medium text-neutral-300 ">Contact Us</h2>
        <p>
